  ...
  return (
    <div className="wrapper-slider ">
      ...
      <div className='header-text div-slider'>
            ...
            <div className='header-button' for="able">
              <a className='a-basla' for="able" href="browse.html">BAŞLA</a>
            </div>
        </div>
    <div id="carouselExampleIndicators" className="carousel slide div-slider" data-bs-ride="true">
